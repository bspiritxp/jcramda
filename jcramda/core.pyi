...
CurriedF = Union[Callable[[_CT], _CRT], _CRT]
...
@overload
def chain(f1: Callable[[VT, T], RT], f2: Callable[[T], VT], iterable: T = ...) -> CurriedF: ...
...
def combine(seqs: Iterable, r: int = ...) -> CurriedF[T, Iterable[Tuple[T], ...]]: ...
...
def map_(f: Callable[[VT], RT], *iterable: Iterable[VT]) -> CurriedF[Iterable[VT], Iterable[RT]]: ...
...
def eq(a: OT, b: OT = ...) -> CurriedF[OT, bool]: ...
def ne(a: OT, b: OT = ...) -> CurriedF[OT, bool]: ...
...
def and_(a: bool, b: bool = ...) -> CurriedF[bool, bool]: ...
def or_(a: bool, b: bool = ...) -> CurriedF[bool, bool]: ...

def add(a: T, b: T = ...) -> Union[Callable[[T], T], T]: ...
# sub: b - a
def sub(a: T, b: T) -> Union[Callable[[T], T], T]: ...
# dec: a + 1
def dec(a: int) -> int: ...
# inc: a - 1
def inc(a: int) -> int: ...
# floordiv: floor(b / a)
def floordiv(a: T, b: T) -> CurriedF[T, T]: ...
# div: b / a
def div(a: T, b: T = ...) -> CurriedF[T, T]: ...
# inv: -a
def inv(a: T) -> T: ...
# lshift: a << b
def lshift(b: int, a: int = ...) -> CurriedF[int, int]: ...
# mod(b, a) -> a % b
def mod(b: T, a: T = ...) -> CurriedF[T, int]: ...
# mul(a, b) -> a * b
def mul(a: T, b: T = ...) -> CurriedF[T, T]: ...
# matmul(a, b) -> a @ b
...
def pos(a: T) -> T: ...
# pow(b, a) -> a ** b
def pow_(b: int, a: NumberValue = ...) -> CurriedF[NumberValue, NumberValue]: ...
# xor(a, b) -> a ^ b
def xor(a: T, b: T = ...) -> CurriedF[T, T]: ...
# concat( iter1, iter2, ..., itern) ->
def concat(a: _CT, b: _CT = ..., *args: _CT) -> CurriedF: ...

def in_(iterable: Iterable, x: Any = ...) -> CurriedF[VT, bool]: ...
def not_in(iterable: Iterable, x: Any = ...) -> CurriedF[Any, bool]: ...
def countof(x: Any, iterable: Iterable = ...) -> CurriedF[Any, int]: ...
def delitem(idx: Hashable, subable: Any = ...) -> CurriedF[Any, NoReturn]: ...
...
def when(*cases: Iterable[Tuple[Callable, Any]], else_: Union[Callable, ...]=...): ...
def case(cases: dict, v: Any, default: Any=...) -> Any: ...
def always(x: Any, _: Any = ...): ...
def if_else(p: Tuple[Callable, Callable, Callable], value: Any = ...) -> CurriedF: ...
def all_(funcs: Iterable[Callable[[Any], bool]], v: Any) -> CurriedF[Any, bool]: ...
def any_(funcs: Iterable[Callable[[Any], bool]], v: Any) -> CurriedF[Any, bool]: ...
...
def eq_attr(attr_name: str, o1: Any = ..., o2: Any = ...) -> CurriedF[Any, T]: ...
def eq_prop(prop_name: Hashable, s1: Any = ..., s2: Any = ...) -> CurriedF[Any, T]: ...
def has_attr(attr_name: str, obj: T = ...) -> CurriedF[T, bool]: ...
