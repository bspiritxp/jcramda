...
def eq(a: OT, b: OT = ...) -> CurriedF: ...
def ne(a: OT, b: OT = ...) -> CurriedF: ...
...
def all_(funcs: Iterable[Callable[[Any], bool]], v: Any) -> CurriedF: ...
def any_(funcs: Iterable[Callable[[Any], bool]], v: Any) -> CurriedF: ...
...
def has_attr(attr_name: str, obj: T = ...) -> CurriedF: ...
