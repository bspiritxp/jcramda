...
def ilen_lt(n: int, sized: Sized = ...) -> _CF: ...
def ilen_le(n: int, sized: Sized = ...) -> _CF: ...
def ilen_eq(n: int, sized: Sized = ...) -> _CF: ...
def ilen_gt(n: int, sized: Sized = ...) -> _CF: ...
def ilen_ge(n: int, sized: Sized = ...) -> _CF: ...
def len_lt(n: int, sized: Sized = ...) -> _CF: ...
def len_le(n: int, sized: Sized = ...) -> _CF: ...
def len_eq(n: int, sized: Sized = ...) -> _CF: ...
def len_gt(n: int, sized: Sized = ...) -> _CF: ...
def len_ge(n: int, sized: Sized = ...) -> _CF: ...
def is_zero(n: int) -> bool: ...

def is_nan(x: Any) -> bool: ...
def attr_eq(attr_name: str, value: Any, obj: Any = ...) -> _CF: ...
