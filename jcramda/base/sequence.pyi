...
def update_range(upset: Any, seqs: Sequence,
                 start: Any=..., stop: Any=..., step: Any=...) -> Sequence: ...
...
def diff(s1: Sequence, s2: Sequence) -> Any: ...
def startswith(prefix: Any, s: Sequence, start: Any=..., end: Any=...) -> Any: ...
def endswith(suffix: Any, s: Sequence, start: Any=..., end: Any=...) -> Any: ...
def symdiff(func: Any, seq1: Any, seq2: Any): ...
