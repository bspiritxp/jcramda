...
def map_update(f: Callable, d: Mapping, v: Any): ...
...
def flat_concat(*args: Mapping, **kwargs) -> Union[Mapping, Sequence]: ...
...
def pluck(key: KT, mapper: Mapping[KT, VT], *args: Mapping) -> Iterable[VT]: ...
